defmodule BeaconDemo.MixProject do
  ...
  defp beacon_dep do
    if path = System.get_env("BEACON_PATH") do
      ...
      {:beacon,
       github: "BeaconCMS/beacon", ref: "884fbf717eefc0c9fb51cbc795410e453fa50e17", override: true}
    end
  end
  ...
  defp beacon_live_admin_dep do
    if path = System.get_env("BEACON_LIVE_ADMIN_PATH") do
      ...
      {:beacon_live_admin,
       github: "BeaconCMS/beacon_live_admin", ref: "12e9006c576f7e2d6d4aadf1d8dbcc08dda7af8c"}
    end
  end
