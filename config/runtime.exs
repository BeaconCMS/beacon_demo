...
config :beacon, :demo,
  ...
  endpoint: BeaconDemoWeb.DemoEndpoint,
...
#
#     PHX_SERVER=true bin/beacon_demo start
#
...
if config_env() == :prod do
  ...
  config :beacon_demo, BeaconDemoWeb.ProxyEndpoint,
    check_origin: {BeaconDemoWeb.ProxyEndpoint, :check_origin, []},
  ...
  #
  #     config :beacon_demo, BeaconDemo.Mailer,
